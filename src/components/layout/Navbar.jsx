...
export default function Navbar() {
  ...
  const handleSave = async () => {
    if (!formData.name.trim() || !formData.email.trim()) return alert("All fields required");
    try {
      setSaving(true);
        ...
        >
          ...
          >
            ...
            <input
              ...
              placeholder="Name"
              className="w-full mb-3 px-4 py-2 border rounded-lg dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-black focus:ring-2 focus:ring-purple-500"
            />
            <input
              type="email"
              ...
              placeholder="Email"
              className="w-full mb-4 px-4 py-2 border rounded-lg dark:bg-gray-800 border-gray-300 dark:border-gray-700 text-black focus:ring-2 focus:ring-purple-500"
            />
